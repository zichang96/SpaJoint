...
```
pip install numpy==1.22.4 pandas==2.0.3 scanpy==1.9.8 scipy==1.10.1 squidpy==1.2.3 tqdm==4.66.5 h5py==3.11.0 scikit-misc==0.2.0
```
# Tutorials
A step-by-step tutorial using scRNA-seq and ST  example data ([link](https://github.com/zichang96/SpaJoint/tree/main/example)) which were generated by selecting highly variable genes and randomly sampling 500 cells and spots respectively from the original hippocampus data is demonstrated here: [link](https://github.com/zichang96/SpaJoint/blob/main/tutorial.py)
